...
// Reads a .chr binary save file and dumps all length-prefixed
// key-value pairs found in the data.
// filepath: path to the Player.chr file to parse.
void
parse_character(const char *filepath)
{
...
// Entry point. Parses arguments and invokes parse_character().
// argc: argument count (must be >= 2).
// argv: argument vector; argv[1] is the .chr file path.
// Returns 0 on success, 1 if no file argument given.
int
