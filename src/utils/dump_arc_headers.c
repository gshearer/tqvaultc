...
// Entry point. Loads an .arc file and dumps hex headers plus DDS magic
// detection for up to 100 entries.
// argc: argument count.
// argv: argument vector; argv[1] is the .arc file path.
