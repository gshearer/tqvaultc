...
// Entry point. Looks up a record path in the resource index, loads the
// corresponding .arz file, and prints all variables from the record.
// argc: argument count.
// argv: argument vector; argv[1] is the record path to look up.
